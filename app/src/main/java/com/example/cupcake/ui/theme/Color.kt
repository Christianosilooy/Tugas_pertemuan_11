...
val md_theme_light_primary = Color(0xFF2196F3) // pemilihan warna untuk tombol
val md_theme_light_onPrimary = Color(0xFFFFFFFF) //pemilihan warna untuk tulisan
val md_theme_light_primaryContainer = Color(0xFF635F5F)//pemilihan warna untuk bagian header
...
val md_theme_light_background = Color(0xFFFFFFFF)// untuk melakukan pada aplikasi
